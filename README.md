...
- Сначала выводится главное фото из результата поиска (`picture`), затем фотографии номера.
...
1. `tour.picture` — главное/продающее фото из результата поиска, если Tourvisor его вернул.
2. До двух фотографий выбранного номера из `/search/api/v1/rooms`.

Если главное фото отсутствует, выводятся только доступные фотографии номера.
